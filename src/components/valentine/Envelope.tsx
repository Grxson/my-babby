      ...
      >
        ...
        <defs>
          ...
          <linearGradient id="envelopeGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="hsl(46, 35%, 94%)" />
            <stop offset="50%" stopColor="hsl(42, 30%, 90%)" />
            <stop offset="100%" stopColor="hsl(45, 28%, 88%)" />
          </linearGradient>
          ...
          <linearGradient id="flapGradient" x1="0%" y1="0%" x2="100%" y2="100%">
            <stop offset="0%" stopColor="hsl(46, 32%, 93%)" />
            <stop offset="100%" stopColor="hsl(42, 28%, 89%)" />
          </linearGradient>
        ...
        >
          ...
          <path
            d="M20 80 L200 170 L380 80 L380 88 Q380 80 370 80 L30 80 Q20 80 20 88Z"
            fill={isOpen ? "hsl(42, 30%, 88%)" : "url(#flapGradient)"}
            stroke="hsl(42, 25%, 80%)"
            strokeWidth="2.5"
      ...
      {isOpen && (
        <>
          {[...Array(8)].map((_, i) => (
            ...
            >
              <svg width="24" height="24" viewBox="0 0 24 24" fill="hsl(42, 50%, 65%)">
