...
const ScratchCanvas = ({ width, height, onRevealProgress, children }: ScratchCanvasProps) => {
  ...
  useEffect(() => {
    ...
    ctx.fillStyle = 'hsl(46, 20%, 30%)';
    ctx.textAlign = 'center';
    ctx.fillText('Raspa aquí para revelar', width / 2, height / 2 - 10);
    ctx.font = '14px Inter, sans-serif';
    ctx.fillStyle = 'hsl(46, 15%, 40%)';
    ctx.fillText('Usa tu dedo o el cursor', width / 2, height / 2 + 20);
  }, [width, height]);
